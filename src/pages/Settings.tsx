...
import { Building2, KeyRound, Users, Key, Calendar, LayoutDashboard } from "lucide-react";
...
export default function Settings() {
  ...
  const tabs = [
    ...
    { path: "/settings/dashboard", label: "Dashboard", icon: LayoutDashboard, module: "settings" as const },
